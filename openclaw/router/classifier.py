...
_CODE_KEYWORDS = {"write code","debug","fix the bug","implement","function","class ","script","refactor","unit test","sql query","api endpoint","dockerfile","regex","algorithm","syntax error","traceback","import ","def ","async "}
